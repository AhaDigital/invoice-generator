    ...
    <header className="row margin-lg">
      ...
      <div className="col col-6">
        ...
        <div className="row margin-df">
          ...
          <div className="col col-8">
            <p style={{ whiteSpace: 'pre-line' }} className="margin-sm">{'Anders Fredriksson'}</p>
            <p style={{ whiteSpace: 'pre-line' }}>{'AF bergarbeten AB'}</p>
            <p style={{ whiteSpace: 'pre-line' }}>{'Steninge backe 5, 195 58 Märsta'}</p>
          </div>
        </div>
        <div className="row margin-df">
          <div className="col col-4">
